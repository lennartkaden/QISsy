...
- Function `parse_base_score_row`: Parse single row of scores into Module model
- Function `parse_individual_score_row`: Parse single row of scores into Score model
